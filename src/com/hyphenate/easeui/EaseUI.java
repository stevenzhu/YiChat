...
public final class EaseUI {
	 ...
	 * 
	 * @return boolean true if caller can continue to call SDK related APIs
	 *         after calling onInit, otherwise false.
	 * 
	 * @param context
	 * @param options
	 *            use default if options is null
	 * @return
	 */
	public synchronized boolean init(Context context, EMOptions options) {
		...
		// if there is main has remote service, main:onCreate()
		// maybe called twice
		// this check is to make sure SDK will initialized only once
		// return if process name is not main's name since the package
	...
	/**
	 * check the main process name if process name is not qualified, then
