...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
	...
	protected void setUpView() {
		if (chatType == EaseConstant.CHATTYPE_SINGLE) {
			...
			// set title
			// if (null != EaseUserUtils.getUserInfo(toChatUsername)) {
			...
			if (chatType == EaseConstant.CHATTYPE_GROUP) {
				...
				if (group != null) {
					titleBar.setGroupTitle(group.getGroupName());
				}
	...
	protected void setListItemClickListener() {
		messageList.setItemClickListener(new EaseChatMessageList.MessageListItemClickListener() {
			...
			@Override
			public void onBubbleLongClick(View view, EMMessage message) {
				contextMenuMessage = message;
				if (chatFragmentHelper != null) {
					chatFragmentHelper.onMessageBubbleLongClick(view, message);
				}
			}
	...
	protected void addChatRoomChangeListenr() {
		 ...
		 * roomName) { if (roomId.equals(toChatUsername)) {
		 * showChatroomToast(" room : " + roomId + " with room name : " +
		 * roomName + " was destroyed"); getActivity().finish(); } }
		 * 
		 * @Override public void onMemberJoined(String roomId, String
		 * participant) { showChatroomToast("member : " + participant +
		 * " join the room : " + roomId); }
		 * 
		 * @Override public void onMemberExited(String roomId, String roomName,
		 * String participant) { showChatroomToast("member : " + participant +
		 * " leave the room : " + roomId + " room name : " + roomName); }
		 * 
		 * @Override public void onRemovedFromChatRoom(String roomId, String
		 * roomName, String participant) { if (roomId.equals(toChatUsername)) {
		 * String curUser = EMClient.getInstance().getCurrentUser(); if
		 * (curUser.equals(participant)) {
		 * EMClient.getInstance().chatroomManager
		 * ().leaveChatRoom(toChatUsername); getActivity().finish(); }else{
		 * showChatroomToast("member : " + participant +
		 * " was kicked from the room : " + roomId + " room name : " +
		 * roomName); } } }
		 * 
		 * 
		 * // ============================= group_reform new add api begin
		 * 
		 * @Override public void onMuteListAdded(String chatRoomId, Map<String,
		 * Long> mutes) {}
		 * 
		 * @Override public void onMuteListRemoved(String chatRoomId,
		 * List<String> mutes) {}
		 * 
		 ...
		 * {}
		 * 
		 * @Override public void onOwnerChanged(String chatRoomId, String
		 * newOwner, String oldOwner) {}
		 * 
	...
	protected void sendMessage(EMMessage message) {
		...
		message.setAttribute("fire", isFire);
		// send message
	...
	public interface EaseChatFragmentHelper {
		 ...
		 */
		void onMessageBubbleLongClick(View view, EMMessage message);
