...
public class MoreMenuPop implements OnClickListener {
	...
	public MoreMenuPop(View v, Activity activity, Handler handler) {
		...
		View view = LayoutInflater.from(activity).inflate(R.layout.contacts_list_1_more_menu_pop, null);
	...
	public void showAsDropDown() {
		...
		// // 设置整个popupwindow的样式。
		// popupWindow.setAnimationStyle(R.style.AnimationPreviewPlacePop);
		// 使其聚集
