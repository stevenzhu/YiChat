 ...
 * 
 */
public class EaseBubbleImageView extends ImageView {
	...
	public EaseBubbleImageView(Context context) {
		super(context);
		initView(null);
	}

	public EaseBubbleImageView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		initView(attrs);
	}

	public EaseBubbleImageView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(attrs);
	}
