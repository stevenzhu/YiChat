package com.shorigo.view.wheel;
...
public class WheelView extends View {
	...
	private static final int[] SHADOWS_COLORS = new int[] { 0x00FFFFFF, 0x00AAAAAA, 0x00AAAAAA };
	...
	public void setTEXT_SIZE(int size) {
		WheelView.TEXT_SIZE = size;
	}

	/** Top and bottom items offset (to hide that) */
	private static final int ITEM_OFFSET = TEXT_SIZE / TEXT_SIZE;

	/** Additional width for items layout */
	private static final int ADDITIONAL_ITEMS_SPACE = 40;
