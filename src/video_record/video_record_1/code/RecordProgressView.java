...
public class RecordProgressView extends View{
    ...
    private void init(){
        ...
        mBackgroundColor = getResources().getColor(R.color.camera_bg);
        mRecordColor = getResources().getColor(R.color.camera_progress_split);
        mPendingColor = getResources().getColor(R.color.camera_progress_overflow);
        mSpaceColor = getResources().getColor(android.R.color.white);
