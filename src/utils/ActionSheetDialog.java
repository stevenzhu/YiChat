...
public class ActionSheetDialog {
	...
	private void setSheetItems() {
		...
		for (int i = 1; i <= size; i++) {
			...
			View view=LayoutInflater.from(context).inflate(R.layout.action_sheet_item,null);
			TextView itemText=	view.findViewById(R.id.itemText);
			itemText.setText(strItem);

			// 字体颜色
			if (color == null) {
				itemText.setTextColor(Color.parseColor(SheetItemColor.Blue
						.getName()));
			} else {
	...
	public enum SheetItemColor {
		Blue("#037BFF"), Black("#000000"), Green("#19BC9C"),Red("#E64C49");
