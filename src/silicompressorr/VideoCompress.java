package silicompressorr;

import android.os.AsyncTask;

import silicompressorr.videocompression.VideoController;
...
public class VideoCompress {
    ...
    public static VideoCompressTask compressVideoLow2(String srcPath, String destPath, CompressListener listener) {
        VideoCompressTask task =  new VideoCompressTask(listener, VideoController.COMPRESS_QUALITY_LOW2);
        task.execute(srcPath, destPath);
        return task;
    }
