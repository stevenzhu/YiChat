...
import com.shorigo.view.input.emojicon.EaseEmojiconPagerView.EaseEmojiconPagerViewListener;
import com.shorigo.view.input.emojicon.EaseEmojiconScrollTabBar.EaseScrollTabBarItemClickListener;
...
public class EaseEmojiconMenu extends EaseEmojiconMenuBase {
	...
	private void init(Context context, AttributeSet attrs) {
		LayoutInflater.from(context).inflate(R.layout.input_widget_emojicon, this);
