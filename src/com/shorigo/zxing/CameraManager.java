...
public final class CameraManager {
	...
	private static final int MIN_FRAME_WIDTH = ScreenUtils.dp2px(MyApplication.getInstance(), 250);
	private static final int MIN_FRAME_HEIGHT = ScreenUtils.dp2px(MyApplication.getInstance(), 250);;
	private static final int MAX_FRAME_WIDTH = ScreenUtils.dp2px(MyApplication.getInstance(), 250);
	private static final int MAX_FRAME_HEIGHT = ScreenUtils.dp2px(MyApplication.getInstance(), 250);
	 ...
	 * 开关闪光灯
	 */
	private static boolean flashLgihtStatus = false;
	...
	public static void toggleFlashLight() {
		...
		final Camera.Parameters camParam = camera.getParameters();
		if (null == camParam) {
			return;
		}
			...
			new Handler().post(new Runnable() {
				public void run() {
					try {
						...
						LogUtils.d("setParameters", "RuntimeException");
					}
				}
			});
		} else {
