...
import com.hyphenate.easeui.widget.EaseBubbleImageView;

public class EaseChatRowImage extends EaseChatRowFile {
	protected EaseBubbleImageView imageView;
	...
	protected void onFindViewById() {
		...
		imageView = (EaseBubbleImageView) findViewById(R.id.image);
		...
		if (message.direct() == EMMessage.Direct.RECEIVE) {
			if (imgBody.thumbnailDownloadStatus() == EMFileMessageBody.EMDownloadStatus.DOWNLOADING || imgBody.thumbnailDownloadStatus() == EMFileMessageBody.EMDownloadStatus.PENDING) {
				...
				if (!new File(thumbPath).exists()) {
					// to make it compatible with thumbnail received in previous
					// version
