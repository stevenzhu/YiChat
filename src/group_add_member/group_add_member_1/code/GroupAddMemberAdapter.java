...
public class GroupAddMemberAdapter extends BaseAdapter {
	...
	public GroupAddMemberAdapter(Context context, List<Map<String, String>> listMap, Handler mHandler) {
	...
	public View getView(final int position, View convertView, ViewGroup arg2) {
		...
		if (convertView == null) {
			...
			convertView = LayoutInflater.from(context).inflate(R.layout.group_add_member_1_item, null);
