...
public class CollectioinListAdapter extends BaseAdapter {
    ...
    private String type;
	public CollectioinListAdapter(Context context, List<CmsBean> listCmsBean, Handler mHandler, String type) {
