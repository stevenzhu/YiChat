	...
	private void setUpBaseView() {
		...
		if (timestamp != null) {
			if (position == 0) {
				...
				timestamp.setText(utils.DateUtils.convertDate2String(new Date(message.getMsgTime()),"HH:mm"));
...
//		}
		// 设置用户昵称、头像
		new AsyncTopImgLoadTask(context, message.getFrom(), usernickView, userAvatarView).execute();
