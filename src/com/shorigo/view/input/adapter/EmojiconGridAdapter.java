package com.shorigo.view.input.adapter;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (convertView == null) {
			if (emojiconType == Type.BIG_EXPRESSION) {
				convertView = View.inflate(getContext(), R.layout.input_row_big_expression, null);
			} else {
				convertView = View.inflate(getContext(), R.layout.input_row_expression, null);
			}
		}
		...
		if (EaseSmileUtils.DELETE_KEY.equals(emojicon.getEmojiText())) {
			...
			if (emojicon.getIcon() != 0) {
				...
				BitmapHelp.loadImg(getContext(), imageView, emojicon.getIconPath());
			}
		}
