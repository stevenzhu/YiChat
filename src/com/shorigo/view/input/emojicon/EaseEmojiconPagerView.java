package com.shorigo.view.input.emojicon;
...
import com.shorigo.view.input.adapter.EmojiconGridAdapter;
import com.shorigo.view.input.adapter.EmojiconPagerAdapter;
import com.shorigo.view.input.model.EaseEmojicon;
import com.shorigo.view.input.model.EaseEmojicon.Type;
...
public class EaseEmojiconPagerView extends ViewPager {
	...
	public List<View> getGroupGridViews(EaseEmojiconGroupEntity groupEntity) {
		...
		for (int i = 0; i < pageSize; i++) {
			View view = View.inflate(context, R.layout.input_expression_gridview, null);
