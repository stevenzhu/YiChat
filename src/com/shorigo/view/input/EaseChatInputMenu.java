...
import com.shorigo.view.input.EaseChatPrimaryMenuBase.EaseChatPrimaryMenuListener;
import com.shorigo.view.input.emojicon.EaseEmojiconMenu;
import com.shorigo.view.input.emojicon.EaseEmojiconMenuBase;
import com.shorigo.view.input.emojicon.EaseEmojiconMenuBase.EaseEmojiconMenuListener;
import com.shorigo.view.input.model.EaseDefaultEmojiconDatas;
import com.shorigo.view.input.model.EaseEmojicon;
import com.shorigo.view.input.model.EaseEmojiconGroupEntity;
import com.shorigo.view.input.utils.EaseSmileUtils;
...
public class EaseChatInputMenu extends LinearLayout {
	...
	private void init(Context context, AttributeSet attrs) {
		...
		layoutInflater.inflate(R.layout.input_widget_input_menu, this);
	...
	public void init(List<EaseEmojiconGroupEntity> emojiconGroupList) {
		...
		if (chatPrimaryMenu == null) {
			chatPrimaryMenu = (EaseChatPrimaryMenu) layoutInflater.inflate(R.layout.input_layout_chat_primary_menu, null);
		}
		primaryMenuContainer.addView(chatPrimaryMenu);

		// emojicon menu, use default if no customized one
		if (emojiconMenu == null) {
			emojiconMenu = (EaseEmojiconMenu) layoutInflater.inflate(R.layout.input_layout_emojicon_menu, null);
	...
	public void setHint(String text) {
		getPrimaryMenu().onTextSetHint(text);
	}
	...
	public void showKeyboard() {
		...
		chatPrimaryMenu.showKeyboard(chatPrimaryMenu.getEditText());
	}
